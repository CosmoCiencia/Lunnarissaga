...
export default function Book(props: GroupProps) {
  ...
  useEffect(() => {
    ...
    // 🔥 diferimos el procesamiento para no bloquear el primer render
  ...
  useEffect(() => {
    return () => {
      if (bookScene) disposeClonedMaterials(bookScene);
    };
  }, [bookScene]);
  ...
  // 🔥 evita render hasta que esté listo (sin bloquear canvas)
