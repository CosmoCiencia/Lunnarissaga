...
var rootDir = path.dirname(fileURLToPath(new URL(import.meta.url)));
var mobileLayoutConfigPath = path.join(rootDir, 'src/config/mobile-layout.json');
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, writeFile(mobileLayoutConfigPath, "".concat(JSON.stringify(parsed, null, 2), "\n"), 'utf8')];
                                case 1:
                                    _a.sent();
                                    res.statusCode = 200;
                                ...
                                case 2:
                                    ...
                                    res.end(JSON.stringify({
                                        ok: false,
                                        error: error_1 instanceof Error ? error_1.message : 'No se pudo guardar',
                                    }));
                                    return [3 /*break*/, 3];
